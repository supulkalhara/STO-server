...
> FastAPI backend powering the Safe TakeOff ATC decision-support platform.  Deployed at **https://sto-server.onrender.com**
...
| `metar_category_code` | METAR | Weather category code |
| `cloud_cover` | METAR | Cloud cover percentage |
| `precipitation_type` | METAR | Precipitation type (if any) |
| `precipitation_intensity` | METAR | Precipitation intensity |
| `runway_condition` | METAR | Runway condition code |
| `visibility_observed` | METAR | Visibility observed at time of report |
| `temperature_dewpoint_diff` | Computed | Temperature minus dew point difference |
| `pressure_tendency` | METAR | Pressure tendency |
| `wind_direction_deg` | METAR | Wind direction in degrees |
| `flight_level` | METAR | Flight level |

---

## Contributing

We welcome contributions to Safe TakeOff! Please read our [CONTRIBUTING.md](CONTRIBUTING.md) for details on how to contribute.

---

# License

Safe TakeOff is licensed under the MIT License. See the [LICENSE](LICENSE) file for more information.